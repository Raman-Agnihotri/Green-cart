                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center gap-0.5 mt-1">
                        {Array(5).fill('').map((_, i) => (
                          <img src={i < (product.averageRating || 0) ? assets.star_icon : assets.star_dull_icon} alt="" className="md:w-4 w-3.5"/>
                             
                        ))}
                        <p className="text-base ml-2">({product.totalReviews || 0})</p>
                    </div>
                    ...
                    <div className="flex items-center mt-10 gap-4 text-base">
                        ...
                        <WishlistButton productId={product._id} className="p-3.5 border border-gray-300 rounded hover:bg-gray-50" />
                    </div>
                </div>
            </div>
            {/* ---------- related products -------------- */}
